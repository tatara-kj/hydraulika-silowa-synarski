...
function ServiceSection({
  ...
  return (
    <section id={id} className="card-lift border border-steel-200 bg-white p-7 sm:p-10">
        ...
        <div className="mx-auto max-w-[1280px]">
          ...
          <div className="mt-8 border-l-4 border-hydraulic-600 bg-[#eaf6fd] p-6 sm:p-8">
            ...
            <p className="mt-4 max-w-4xl text-steel-700">
              Wymiary, ciśnienie, materiały, sposób testowania i dokumentację ustalamy
              dla konkretnego zastosowania oraz dostarczonych danych technicznych.
            </p>
          </div>
        </div>
      </section>
